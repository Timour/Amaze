...
DIALOG_LAYOUT = {    # ▸ EVERY DRAWN FIGURE: (kind, x, y, w, h, text) per node, per frame; `AmazeNotes/tools/figma-diff.py` checks Figma against it ▸p/one-design-document
    ...
    "D08b": {   # Preferences - About, after Check for Updates
        "frame": (490, 517),
        "nodes": (
            ("QTabBar", 12, 12, 466, 22, None),
            ("QTabBar::tab ▸ Library", 26, 16, 36, 15, "Library"),
            ...
            ("QTextBrowser", 20, 42, 450, 253, None),
            ("QScrollBar", 454, 42, 16, 253, None),
            ("QPushButton", 260, 401, 64, 22, None),
            ("QPushButton ▸ text", 268, 405, 48, 15, "Open Log"),
            ("QPushButton", 332, 401, 70, 22, None),
            ("QPushButton ▸ text", 340, 405, 54, 15, "Save Log..."),
            ("QPushButton", 408, 401, 62, 22, None),
            ("QPushButton ▸ text", 416, 405, 47, 15, "Clear Log"),
            ("ToggleSwitch", 148, 402, 96, 19, None),
            ("ToggleSwitch ▸ text", 165, 404, 63, 15, "Debug Mode"),
            ("ToggleSwitch", 148, 450, 91, 19, None),
            ("ToggleSwitch ▸ text", 164, 452, 59, 15, "Test Library"),
            ("QLabel", 85, 478, 55, 15, "Test Folder"),
            ("QLineEdit", 148, 475, 292, 22, None),
            ("QPushButton", 442, 475, 28, 22, None),
            ("QPushButton ▸ text", 452, 479, 9, 15, "..."),
            ("QPushButton", 148, 303, 108, 22, None),
            ("QPushButton ▸ text", 156, 307, 92, 15, "Check for Updates"),
            ("QPushButton", 264, 303, 90, 22, None),
            ("QPushButton ▸ text", 272, 307, 74, 15, "Report a Bug..."),
            ("QLabel", 148, 331, 322, 15, "You are running 1.0.31, which is the newest release."),
            ("QPushButton", 148, 352, 90, 22, None),
            ("QPushButton ▸ text", 156, 356, 70, 15, "Install Update"),
        ),
    },
