...
class MatLibPanel(QtWidgets.QWidget):
    ...
    def _build_menus(self) -> None:
        ...
        if self.toolbar_layout is not None:
            ...
            # blue in ALL FOUR states - his call 2026-08-01, "keep it
            ...
            # is the whole signal
            # that you are in the other world - his call: "the yellow
    ...
    def _mirror_toolbar(self) -> None:
        ...
        # gear's left when the File tab shows it (2026-08-01, his
    ...
    def tile_delegates(self) -> tuple:
        ...
        left to whoever remembered. Nobody did, which is the defect he
        reported as "type is under category and continues to halfway to
    ...
    def _import_materials_into_context(self, context, ids) -> None:
        ...
        group: the whole multi-drop reverts as one step."""
    ...
    def _sync_notes_button_pixmaps(self) -> None:
        ...
        His call 2026-08-01: the Comments blue belongs to the section
