...
class Spec:
    ...
    def __init__(self, filename, payload, keyspace, label, noun,
        ...
        #:
        #: NOTHING path-keyed survives a location removal, as of HIS
...
register(
    ...
    refused_sentence=(
        ...
        "already in it."),
    # HIS CALL, 2026-08-03: "clear everything - favourites, comments and
...
def retire_prefix(preferences, prefix: str) -> dict:
    ...
    path-keyed store answers the same way - his "clear everything -
