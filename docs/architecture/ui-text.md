...
Built from his Framer page, 2026-08-02 - the first HTML handover. The
...
- The dropdown, the field and the buttons are STANDARD Houdini
  controls at the design's geometry. The grey boxes in his page mark
  where a control goes, not what it should look like.
- His numbers are DEVICE pixels - he draws on a Retina screen - and
