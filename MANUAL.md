...
| <img src="scripts/python/amaze/ui/badge_versions.svg" width="100"> | lower-left | has more than one [version](#versions) — click it to browse them |
| <img src="scripts/python/amaze/ui/badge_comment_75.svg" width="100"> | lower-right | carries a [comment](#comments) — click it to open the Comments pane on that asset |
